...
router.get('/categoriasVirtuales/plan/:idPlan', PrestadorController.getCategoriasVirtuales);
...
router.get('/especialidadesVirtuales/categoria/:idCategoria/plan/:idPlan', PrestadorController.getEspecialidadesVirtuales);
...
router.get('/prestadoresVirtuales/categoria/:idCategoria/plan/:idPlan/especialidad/:idEspecialidad', PrestadorController.getPrestadoresVirtuales);
...
router.get('/categoriasVirtualesEdit/plan/:idPlan/edit/:edit', authMiddleware(), PrestadorController.getCategoriasVirtuales);
...
router.get('/especialidadesVirtualesEdit/categoria/:idCategoria/plan/:idPlan/edit/:edit', authMiddleware(), PrestadorController.getEspecialidadesVirtuales);
...
router.get('/nombresPrestadores', authMiddleware(),PrestadorController.getNombresPrestadores);
...
router.get('/prestadoresVirtualesEdit/categoria/:idCategoria/plan/:idPlan/especialidad/:idEspecialidad/edit/:edit', authMiddleware(), PrestadorController.getPrestadoresVirtuales);
router.post('/subir-cartilla', authMiddleware(), PrestadorController.uploadCSV);
router.post('/subir-portada', authMiddleware(), PrestadorController.updatePortadaPDF);
