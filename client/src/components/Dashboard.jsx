              ...
              <div className="col-12">
                  <div className="border shadow-input p-3 rounded-3 shadow mb-4">
                      ...
                      <div className='cards-row'>
                          ...
                          {/* Card de editar un prestador por nombre */}
                          <div className="card backound-color text-white fw-bolder rounded-5 card-fixed-width mb-3">
                              <div className="card-body div-background rounded-5">
                                  <span className='d-flex justify-content-between fs-5 pt-3 pe-1'> 
                                      <p className='p-0 m-0 pe-1'>Modificar estado de prestador</p> 
                                      <div className="flex-grow-0">
                                          <Link to="/editar-prestador-por-nombre" className="text-uppercase text-decoration-none link-card">
                                              Ir <FaRegArrowAltCircleRight />
                                          </Link>
                                      </div>
                                  </span>
                              ...
                              <div className="card-body">
                                  <p className="card-text border-bottom border-top p-4">Modificá el estado de un prestador, por nombre, de forma masiva.</p>
                                  <h5 className="card-title text-uppercase p-3 fs-3 fw-bold text-center">Editar Estado Prestador</h5>
                              </div>
                          </div>
                      </div>
                  </div>
