...
import { MdDragHandle } from "react-icons/md"; // Nuevo icono para ordenamiento
...
const DashboardPlan = () => {
  ...
  // Nueva card para ordenamiento de planes
  const cardOrdenarPlanes = {
    title: "Ordenar planes",
    link: "/ordenar-planes", // Asegúrate de que esta ruta esté configurada en tu router
    description:
      "Organizá el orden en que aparecen los planes en el formulario de búsqueda. Arrastrá y soltá para reordenar.",
    icon: MdDragHandle,
  };
    ...
    <div>
      ...
      <div className="d-flex justify-content-center align-items-start min-vh-74 mt-5">
        <div className="w-75 d-flex flex-column border mb-4 shadow-input border p-4 custom-height shadow rounded-3">
          ...
          <h4 className='mb-4 subtitle-dashboard'>Ordenamiento de planes</h4>
          <Card {...cardOrdenarPlanes} />
